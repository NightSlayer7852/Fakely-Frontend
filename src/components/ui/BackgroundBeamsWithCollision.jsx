    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-secondary",
    ...
    return (
        <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
            <motion.div
                ...
                className="absolute -inset-x-10 top-0 m-auto h-2 w-10 rounded-full bg-secondary blur-sm"
            ></motion.div>
