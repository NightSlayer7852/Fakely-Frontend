        ...
        <div>
            <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
                ...
                <nav>
                    ...
                    <a className="link link-hover">Custom Model Training</a>
                    <a className="link link-hover">System Integration</a>
                    <a className="link link-hover">Real-time Monitoring & Alerts</a>
            ...
            <p className="flex justify-center bg-base-200 pb-2">Copyright © {new Date().getFullYear()} - All rights reserved by Fakely</p>
        </div>
    );
}